...
public class FileOperationCompletedEventArgs extends EventArgs {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setSplitStrings(List<java.lang.String> value) {
    try {
      javonetHandle.set("SplitStrings", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public List<java.lang.String> getSplitStrings() {
    try {
      Object res = javonetHandle.<NObject>get("SplitStrings");
      if (res == null) return null;
